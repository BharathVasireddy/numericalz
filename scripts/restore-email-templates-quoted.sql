-- 🔄 RESTORE EMAIL TEMPLATES FROM BACKUP (QUOTED COLUMNS)
-- Date: 2025-07-08
-- Purpose: Restore email templates using properly quoted column names
...
-- Success message
SELECT 'SUCCESS: Email template restored from backup with quoted columns' as result; 