-- Add missing email communication system tables and enums
...
-- Add missing fields to email_logs table
ALTER TABLE "email_logs" ADD COLUMN "templateId" TEXT;
ALTER TABLE "email_logs" ADD COLUMN "templateData" TEXT;

-- CreateIndex
CREATE INDEX "email_templates_category_idx" ON "email_templates"("category");
CREATE INDEX "email_templates_createdByUserId_idx" ON "email_templates"("createdByUserId");
...
-- AddForeignKey
ALTER TABLE "email_templates" ADD CONSTRAINT "email_templates_lastModifiedByUserId_fkey" FOREIGN KEY ("lastModifiedByUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
