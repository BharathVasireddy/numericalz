...
export const ComprehensiveActivityTypes = {
  ...
  LTD_ACCOUNTS_FILING_UNDONE: 'LTD_ACCOUNTS_FILING_UNDONE',

  // Workflow Management - Non-Ltd Companies
  NON_LTD_WORKFLOW_CREATED: 'NON_LTD_WORKFLOW_CREATED',
  NON_LTD_WORKFLOW_UPDATED: 'NON_LTD_WORKFLOW_UPDATED',
  NON_LTD_WORKFLOW_STAGE_CHANGED: 'NON_LTD_WORKFLOW_STAGE_CHANGED',
  NON_LTD_WORKFLOW_ASSIGNED: 'NON_LTD_WORKFLOW_ASSIGNED',
  NON_LTD_WORKFLOW_UNASSIGNED: 'NON_LTD_WORKFLOW_UNASSIGNED',
  NON_LTD_WORKFLOW_COMPLETED: 'NON_LTD_WORKFLOW_COMPLETED',
  NON_LTD_WORKFLOW_CLIENT_SELF_FILING: 'NON_LTD_WORKFLOW_CLIENT_SELF_FILING',
  NON_LTD_ACCOUNTS_FILED: 'NON_LTD_ACCOUNTS_FILED',
  NON_LTD_ACCOUNTS_FILING_UNDONE: 'NON_LTD_ACCOUNTS_FILING_UNDONE',
